...
\caption{Participants were divided into 4 groups by the tools they used and diagramming domains of the tasks. Each row corresponds to the task sequence of one of the groups. Participants used both \Edgeworth and Google Drawings to author problems for two prompts in chemistry or geometry (\cref{fig:edgeworth-user-study-tasks}).}
\end{table}
...
\subsection{Tool Familiarity and Learning Curve}
...
Finally, \Edgeworth is a tool still under development, and the studies were conducted on a particular version of the software. As the tool evolves, with potential updates and improvements, the findings presented here might become outdated. Future research would need to re-evaluate the tool's performance and usability in light of these changes.
