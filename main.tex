...
\usepackage[backend=biber,style=numeric,citestyle=numeric,maxbibnames=99,natbib=true,maxcitenames=2,backref,backrefstyle=none]{biblatex}
...
This chapter is adapted from \citetitle{penrose}~\cite{penrose}
}}
\label{chp:penrose}

\input{penrose}

\chapter[\Edgeworth: Diagrammatic Problem Authoring at Scale]{\Edgeworth: Diagrammatic Problem Authoring at Scale\footnote{This chapter is adapted from Sections 1 to 5 of \citetitle{ni_edgeworth_2024}~\cite{ni_edgeworth_2024}}}
\label{chp:edgeworth}
\input{edgeworth}

\chapter[Evaluating \Edgeworth{}]{Evaluating \Edgeworth{}\footnote{This chapter is partly adapted from Sections~6 to 7 of \citetitle{ni_edgeworth_2024}~\cite{ni_edgeworth_2024}}}
