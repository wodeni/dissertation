...
Experts solve difficult problems by representing ideas visually. In \citetitle{doingWithImages}, Alan Kay described the widespread use of visual representations among experts in math and physics:\footnote{Originally published in \citetitleyear{hadamard_psychology_1945}\cite{hadamard_mathematicians_1945, hadamard_mathematicians_1997}.}
\begin{quote}
