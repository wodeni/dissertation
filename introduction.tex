...
\boxtext{\textbf{RQ1:} \label{rq:diagrammer} How do diagrammers utilize the strengths and cope with the limitations of their diagramming tools?}
...
\boxtext{\textbf{RQ2:} \label{rq:expressiveness} How effectively can \Penrose's language-based specification express a wide range of diagramming domains without requiring significant modification to the system's core design? }
...
\boxtext{
\textbf{RQ3.1:} \label{rq:mut} Can \Edgeworth reliably generate translation problems with relatively few variations required?

\textbf{RQ3.2:} \label{rq:eff} Comparing with a conventional drawing tool, are authors more efficient at making translation problems using \Edgeworth? 

\textbf{RQ3.3:} \label{rq:eco} Do real-world instructors consider \Edgeworth-generated translation problems to be useful? 
}
